    ...
    <div class="parameter-config-panel" :class="{ active: isOpen }">
      ...
      <div class="panel-header">
        ...
        <div class="header-actions">
          <button class="action-btn" @click="resetToDefaults" aria-label="恢复默认">
            <Icon icon="material-symbols:refresh" width="20" height="20" />
          </button>
          <button class="action-btn" @click="closePanel" aria-label="关闭">
      ...
      <div class="panel-content">
        ...
        <!-- Middleware Section - REMOVED -->
        <!-- <div class="settings-group middleware-section">
          <h3 class="section-title">中间件</h3>
